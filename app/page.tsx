                ...
                <div className="flex flex-row gap-16">
                    <div className="flex flex-col">
                        ...
                        <p className="text-lg flex flex-row gap-2 font-medium">Hosts: 
                            <Link href="/api/og?title=Generating%20Opengraph%20thumbnails%20and%20images%20from%20HTML%20and%20CSS%20without%20using%20a%20browser%20instance&pagetype=non-existant%20page" className="bg-neutral-900 px-1 hover:bg-neutral-800 rounded-md">nb-og</Link>
                        </p>
